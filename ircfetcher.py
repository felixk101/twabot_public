...
NICK = "hochschuleaugsburg"                     # Nickname = Twitch username
PASS = "oauth:lhq4ad0tqxgkxu9kxbo65jtpppqm47"   # www.twitchapps.com/tmi/ will help to retrieve the required authkey
# --------------------------------------------- End Settings -------------------------------------------------------
