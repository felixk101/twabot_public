 ...
 */;var Vue=require('vue');Vue.use(require('vue-resource'));var canvasCreation=require('./overviewCanvasCreation');var meinVue=new Vue({el:'#channelOverview',data:{activeChannels:[],emotionChannels:{}}, /**
     * This function will be called, when the website is ready.
     */ready:function ready(){this.fetchChannels()},methods:{ /**
         * Request all channels needed for the overview page.
         */fetchChannels:function fetchChannels(){ // Request the most active channels
this.$http.get('/overview/activeChannels/').success(function(channels){this.$set("activeChannels",channels);this.$nextTick(this.drawThumbnailsActive)}).error(function(error){console.log(error)}); // Request the most emotional channels
